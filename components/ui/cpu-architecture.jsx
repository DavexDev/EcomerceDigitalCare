...
/**
 * @typedef {Object} CpuArchitectureSvgProps
 * @property {string} [className] - Additional CSS classes
 * @property {string} [width="100%"] - SVG width
 * @property {string} [height="100%"] - SVG height
 * @property {string} [text="CPU"] - Text to display in CPU box
 * @property {boolean} [showCpuConnections=true] - Show CPU connection pins
 * @property {number} [lineMarkerSize=18] - Size of line markers
 * @property {boolean} [animateText=true] - Animate CPU text
 * @property {boolean} [animateLines=true] - Animate paths
 * @property {boolean} [animateMarkers=true] - Animate path markers
 */
    ...
    >
      ...
      <defs>
        ...
        <radialGradient id="cpu-green-grad" fx="1">
          ...
          <stop offset="50%" stopColor="#00DD00" />
          <stop offset="100%" stopColor="transparent" />
        </radialGradient>
        ...
        <radialGradient id="cpu-cyan-grad" fx="1">
          ...
          <stop offset="50%" stopColor="#00DDDD" />
          <stop offset="100%" stopColor="transparent" />
        </radialGradient>
